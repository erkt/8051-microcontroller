//2.	What value do we need to load into the timer's registers if we want to have time delay of 10ms.Write the program for infinitely creating a pulse width of 10ms P0.7.
LCD EQU P0
RS BIT P3.4
RW BIT P3.5
EN BIT P3.6
